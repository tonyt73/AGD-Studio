...
private:    // User declarations
    ...
    WindowDocument*             m_WindowDocument;
    std::unique_ptr<TBitmap>    m_WindowView;
    int                         m_Scalar;

    void            __fastcall  OnEvent(const Event& event);
    bool            __fastcall  IsActive() const;
    void            __fastcall  DrawWindow();
...
public:        // User declarations
    ...
    __property  WindowDocument* Window = { read = m_WindowDocument, write = m_WindowDocument };
};
//---------------------------------------------------------------------------
#endif
