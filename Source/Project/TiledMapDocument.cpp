...
//---------------------------------------------------------------------------
void  TiledMapDocument::OnDocumentChanged(const ::Messaging::DocumentChange<String>& message)
{
...
//---------------------------------------------------------------------------
void  TiledMapDocument::OnSetStartRoom(const ::Messaging::SetStartRoom& event)
{
