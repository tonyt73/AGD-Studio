...
__published:
    __property  String   __fastcall Classification  = { read = m_Folder                         };
    __property  String   __fastcall Name            = { read = m_Name, write = SetName          };
    __property  String   __fastcall Path            = { read = m_File                           };
};
//---------------------------------------------------------------------------
