...
std::unique_ptr<TLMDStarterExt> m_Shell;
			...
			void    __fastcall  OnOutputEvent(TObject* ASender, const System::UnicodeString ANewLine);
			void    __fastcall  OnErrorEvent(TObject* ASender);
            void    __fastcall  OnTerminatedEvent(TObject* ASender);
