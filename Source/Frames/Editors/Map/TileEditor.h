...
private:
   ...
   const Visuals::GraphicsMode& m_GraphicsMode;     // the graphics mode used by the project
    ...
    TPoint                      m_SelectedRoom;     // the currently selected room
    ...
    bool                        m_ShowSpecialRooms; // show the start, disabled and empty rooms highlighted
    ...
    void            __fastcall  SelectRoom(TPoint room);
    ...
    void            __fastcall  SetShowSpecialRooms(bool state);
    ...
    void            __fastcall  DrawSpecialRooms() const;
...
public:
    ...
    const Project::MapEntityList&
                    __fastcall  GetEntities() const;
    Project::MapEntityList
                    __fastcall  GetSelection(Visuals::ImageTypes type = Visuals::itAll, bool resetToOrigin = false) const;
