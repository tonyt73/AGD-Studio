...
//---------------------------------------------------------------------------
std::vector<String>  Importer::m_Keywords =
{
	/* Some keywords. */
	"IF",				// if.
...
//---------------------------------------------------------------------------
std::vector<String>  Importer::m_EventFiles =
{
...
{
    if (System::File::Extension(file) == "sna")
    {
...
{
    ::Messaging::Bus::Publish<OnImportWindow>(OnImportWindow(m_ValueOf.WindowPosition, m_ValueOf.WindowSize));
}
//---------------------------------------------------------------------------
void __fastcall Importer::ImportMessages() const
{
    // TODO: Parse messages
    String messages = "testing of the messages";
    ::Messaging::Bus::Publish<OnImport<String>>(OnImport<String>("messages", messages));
}
//---------------------------------------------------------------------------
void __fastcall Importer::ImportEvents() const
{
    // TODO: Parse events code
    // ForEach event
    //      Publish("event." + event.name, code);
}
//---------------------------------------------------------------------------
void __fastcall Importer::ImportFont() const
{
}
//---------------------------------------------------------------------------
void __fastcall Importer::ImportBlocks() const
{
}
//---------------------------------------------------------------------------
void __fastcall Importer::ImportSprites() const
{
}
//---------------------------------------------------------------------------
void __fastcall Importer::ImportObjects() const
{
}
//---------------------------------------------------------------------------
void __fastcall Importer::ImportScreens() const
{
}
//---------------------------------------------------------------------------
void __fastcall Importer::ImportMap() const
{
}
//---------------------------------------------------------------------------
